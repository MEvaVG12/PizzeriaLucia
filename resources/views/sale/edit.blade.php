...
<div class="panel-body">
    <div class='form-group'>
        <label for="title" class='control-label'>Cliente: </label> {{ $sale->client }}
    </div>
    <div class='form-group'>
        <label for="title" class='control-label'>Fecha  y hora de pedido:</label> {{ Carbon\Carbon::parse($sale->orderDateTime)->format('d/m/Y H:i') }}
    </div>
    <div class='form-group'>
...
saleUpdateRoute = "{{url('api/sale/update')}}";
</script>
